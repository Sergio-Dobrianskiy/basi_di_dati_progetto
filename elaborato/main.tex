...
\usepackage{listings}
\usepackage{microtype}  % gestisce alcune a capo per parole lunghe
...
\input{doc/4_1_Stima_del_volume_dei_dati}
...
\input{doc/4_8_Traduzioni_delle_operazioni_in_query_SQL}
...
% \input{doc/Traduzione_associazioni}
% \section{Interfaccia utente}
% \input{doc/7_Interfaccia_utente}
% \subsection{L'amministratore}
% \input{doc/7_1_L'amministratore}
% \subsection{Il fornitore}
% \input{doc/7_2_Il_fornitore}
