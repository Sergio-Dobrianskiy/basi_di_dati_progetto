...
\input{doc/1_Introduzione}


\section{Analisi dei requisiti}

\subsection{Requisiti in linguaggio naturale}
\input{doc/2_1_Requisiti_in_linguaggio_naturale}

\subsection{Estrazione dei concetti fondamentali}
\input{doc/2_2_Estrazione_dei_concetti_fondamentali}

\subsection{Schema Iniziale}
\input{doc/2_3_Schema_iniziale}

\subsection{Raffinamento dello schema ER}
\input{doc/2_4_Raffinamento_schema_ER}

\subsection{Schema Finale}
\input{doc/2_5_Schema_finale}


\section{Progettazione Logica}

\subsection{Stima del volume dei dati}
\input{doc/3_1_Stima_del_volume_dei_dati}

\subsection{Operazioni richieste e la loro frequenza}
\input{doc/3_2_Operazioni_richieste_e_la_loro_frequenza}

\subsection{Schemi di navigazione}
\input{doc/3_3_Schemi_di_navigazione}

\subsection{Analisi delle ridondanze}
\input{doc/3_4_Analisi_delle_ridondanze}

\subsection{Raffinamento dello schema} % TODO
\input{doc/3_5_Raffinamento_dello_schema}

\subsection{Traduzione delle entità}
\input{doc/3_6_Traduzione_entita}

\subsection{Traduzione delle associazioni}
\input{doc/3_7_Traduzione_associazioni}


\subsection{Schema relazionale finale} % TODO
\input{doc/3_8_Schema_relazionale_finale}
...
\input{doc/4_1_Descrizione_architettura_applicazione} 

\subsection{Utente Generico}
\input{doc/4_2_Utente_Generico.tex}

\subsection{L'amministratore}
\input{doc/4_3_Amministratore}

\subsection{Il fornitore}
\input{doc/4_4_Fornitore}

\subsection{Il cliente}
\input{doc/4_5_Cliente}
